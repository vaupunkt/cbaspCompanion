...
export default function ChatBotComponent() {
  ...
  const formFields = [
    ...
    },
    {
      ...
      max: "5",
      required: "true",
      "cf-error": "Must be between 3 and 5",
      name: "interpretations",
      "cf-questions":
        "Interpretation&&Wie viele Interpretationen möchtest du angeben?",
    },
    // {
    //   "cf-conditional-type": "PastAnalysis",
    //   tag: "input",
  ...
  var flowCallback = function (dto, success, error) {
    ...
    if (dto.tag.name === "interpretations") {
      ...
      window.ConversationalForm.addTags(interpretationsArray);
    }
