const placeholder = [
  ...
  },
  {
    ...
    interpretations: [
      "I am capable and qualified for this job",
  ...
  },
  {
    ...
    interpretations: [
      ...
      "I'm not cut out for this subject",
      "Everyone else did better than me",
    ],
  ...
  },
  {
    ...
    interpretations: [
      ...
      "Art is about self-expression, not perfection",
    ],
    rolePlay: "",
    implementation:
