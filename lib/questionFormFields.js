export const innerSituationAnalysisFormFields = [
  ...
  },
  {
    tag: "fieldset",
    type: "text",
    name: "redirectToBehaviorKieslerkreis",
    "cf-questions":
      "Wie schätzt du dein Verhalten im Kieslerkreis ein?&&Ich werde dich jetzt weiterleiten.&&Wenn es nicht klappt, klicke den Link:",
    children: [
      {
        tag: "input",
        type: "radio",
        name: "redirectToBehaviorKieslerkreis",
        value: "redirectToBehaviorKieslerkreis",
        label: "redirectToBehaviorKieslerkreis",
        "cf-label": "<a href='./newanalysis/behaviorkieslerkreis'>Link</a>",
      },
    ],
  },
  {
...
export const futureAnalysisFormFields = [
  ...
  },
  {
    ...
    name: "behavior",
    "cf-questions":
      "Wie kannst du dich verhalten, um dein Ziel zu erreichen? 💪🏼",
  },
  {
