...
export default function MoreInformationPage({ isIOS }) {
  return (
    <>
      <Head>
        ...
        <>
          ...
          <MoreInformationArticle>
            <MoreInformationSection id="depression">
              ...
              <p>
                <strong>Depression</strong> ist eine psychische Störung, die
                durch Episoden von mentaler <strong>Depression</strong>{" "}
                gekennzeichnet ist. Symptome einer <strong>Depression</strong>{" "}
                sind Gefühle von Traurigkeit, Weinen, Hoffnungslosigkeit,
                Kurztemperament, Reizbarkeit, Verlust des Interesses oder
                mangelndes Vergnügen, Gedächtnisverlust, schwache Emotionen,
                Schlafstörungen, Müdigkeit, reduzierter Appetit und
                Gewichtsverlust sowie Gefühle von Wertlosigkeit. Chronische{" "}
                <strong>Depression</strong> bedeutet, dass die{" "}
                <strong>Depression</strong> länger als zwei Jahre angedauert
                hat. Menschen mit chronischer <strong>Depression</strong> haben
                oft eine Vorgeschichte von emotionaler Vernachlässigung oder
                körperlicher Gewalt in ihrer Kindheit.
              </p>
              <p>
                ...
                Erkrankung ist und dass es viele wirksame
            ...
            <MoreInformationSection id="cbaspTherapy">
              ...
              <p>
                ...
                Monaten durchgeführt und kann einzeln oder in Gruppen
                durchgeführt werden. Wenn du an chronischer{" "}
                <strong>Depression</strong> leidest und an{" "}
            ...
            <MoreInformationSection id="getHelp">
              ...
              <p>
                ...
                medizinischen Fachmann über deine Symptome zu sprechen. Sie
                können dir bei der Suche nach einer geeigneten Behandlung helfen
                und dich an einen Spezialisten überweisen.
              </p>
              <p>
              ...
              <h3>
                Hier einige hilfreiche Links und Telefonnummern für Menschen,
              ...
              <ul>
                ...
                <li>
                  <strong>Deutsche Depressionshilfe</strong>: Auf der Website
                  der{" "}
                  ...
                  findest du viele Informationen und Hilfsangebote bei
                  Depression. Dort gibt es auch eine Liste von Klinikadressen
                  und Krisendiensten in deiner Region.
                </li>
                <li>
                  <strong>Telefonseelsorge</strong>: Die Telefonseelsorge ist
                  rund um die Uhr unter den Nummern{" "}
                ...
                <li>
                  ...
                  erreichbar. Die Sprechzeiten sind Mo - Sa von 14:00 - 20:00
                  Uhr.
                </li>
                <li>
                  <strong>Elterntelefon</strong>: Das Elterntelefon ist unter
                  der Nummer{" "}
                  <MoreInformationTextLink href="tel:+498001110550">
                    0800 11 10 55 0
                  </MoreInformationTextLink>{" "}
                  erreichbar. Die Sprechzeiten sind Mo - Fr von 9:00 - 17:00
                  Uhr, Di+Do bis 19:00 Uhr.
                </li>
              </ul>
            </MoreInformationSection>
            <MoreInformationSection id="about">
              ...
              <p>
                ...
                Situationsanalysen der <strong>CBASP</strong>-Therapie
                durchführen kann. Als jemand, der selbst von chronischen
                Depressionen betroffen ist und in <strong>CBASP</strong>
                -Behandlung ist, weiß ich, wie wichtig es ist, Zugang zu
                hilfreichen Ressourcen zu haben. Deshalb habe ich beschlossen,
                meine Fähigkeiten und Erfahrungen zu nutzen, um anderen zu
                helfen.
              </p>
              <p>
                ...
                . Ich hoffe, dass meine App ein paar Menschen helfen kann, die
            ...
            <MoreInformationArticle>
              <MoreInformationSection id="depression">
                ...
                <p>
                  ...
                  <strong>Depression</strong> bedeutet, dass die{" "}
                  <strong>Depression</strong> länger als zwei Jahre angedauert
                  hat. Menschen mit chronischer <strong>Depression</strong>{" "}
                  haben oft eine Vorgeschichte von emotionaler Vernachlässigung
                  oder körperlicher Gewalt in ihrer Kindheit.
                </p>
                <p>
                  <strong>Depression</strong> kann jeden betreffen, unabhängig
                  von Alter, Geschlecht oder sozialem Status. Es gibt viele
                  Faktoren, die zur Entstehung einer <strong>Depression</strong>{" "}
                  beitragen können, darunter genetische Veranlagung,
                  Veränderungen im Gehirnchemie, Stress und traumatische
                  Ereignisse. Es ist wichtig zu beachten, dass{" "}
                  <strong>Depression</strong> eine behandelbare Erkrankung ist
                  und dass es viele wirksame Behandlungsmöglichkeiten gibt.
                </p>
              </MoreInformationSection>
              <MoreInformationSection id="cbaspTherapy">
                <h2>Über CBASP-Therapie</h2>
                <p>
                  <strong>CBASP</strong> (Cognitive Behavioral Analysis System
                  of Psychotherapy) ist eine spezielle Form der kognitiven
                  Verhaltenstherapie, die speziell für die Behandlung von
                  chronischer <strong>Depression</strong> entwickelt wurde.{" "}
                  <strong>CBASP</strong> zielt darauf ab, die Denk- und
                  Verhaltensmuster zu ändern, die zur Aufrechterhaltung der{" "}
                ...
                <p>
                  ...
                  durchgeführt werden. Wenn du an chronischer{" "}
                  <strong>Depression</strong> leidest und an{" "}
                  <strong>CBASP</strong> interessiert bist, sprich mit deinem
              ...
              <MoreInformationSection id="getHelp">
                ...
                <p>
                  Wenn du oder jemand, den du kennst, an{" "}
                  <strong>Depressionen</strong> leidet, ist es wichtig,
                  professionelle Hilfe zu suchen. Es gibt viele Möglichkeiten
                  zur Behandlung von <strong>Depressionen</strong>, darunter
                  Psychotherapie, Medikamente und Selbsthilfegruppen. Ein guter
                  erster Schritt ist es, mit deinem Hausarzt oder einem anderen
                  medizinischen Fachmann über deine Symptome zu sprechen. Sie
                  können dir bei der Suche nach einer geeigneten Behandlung
                  helfen und dich an einen Spezialisten überweisen.
                </p>
                <p>
                  Es ist auch wichtig zu beachten, dass es viele Ressourcen
                  gibt, die dir helfen können, mit <strong>Depressionen</strong>{" "}
                  umzugehen. Dazu gehören Selbsthilfebücher und -websites sowie
                  Online-Support-Gruppen. Es kann auch hilfreich sein, sich an
                  Freunde und Familie zu wenden und ihnen von deinen Gefühlen zu
                  erzählen. Denke daran: Du bist nicht allein und es gibt Hilfe
                  da draußen.
                </p>
                <h3>
                  Hier einige hilfreiche Links und Telefonnummern für Menschen,
                ...
                <ul>
                  <li>
                    ...
                    erreichen. Die Sprechzeiten sind Mo, Di, Do – 13.00 bis
                    17.00 Uhr; Mi und Fr – 08.30 bis 12.30 Uhr.
                  </li>
                  <li>
                    <strong>Deutsche Depressionshilfe</strong>: Auf der Website
                    der{" "}
                  ...
                  <li>
                    ...
                    erreichbar. Es gibt auch eine Mail- und Chatberatung über
                    die{" "}
                    <MoreInformationTextLink href="https://www.telefonseelsorge.de/">
                      Website
                    </MoreInformationTextLink>
              ...
              <MoreInformationSection id="about">
                ...
                <p>
                  Bei der Erstellung der Formulare für die Situationsanalysen
                  habe ich mich stark an den Vorgaben aus dem Buch "
                  <i>Die Mauer überwinden</i>" (ISBN: 3621280853) von Eva-Lotta
                  Brakemeier und Angela Buchholz orientiert. Dieses Buch bietet
                  Strategien aus der <strong>CBASP</strong>-Therapie, um
                  Menschen mit chronischen Depressionen zu helfen, ihre Mauer zu
                  überwinden und ihr Leben wieder selbstbewusst zu gestalten.
                  Ein besonderes Ziel ist die Aufarbeitung von Prägungen durch
                  wichtige Bezugspersonen in der Kindheit, die zur Entwicklung
                  und Verfestigung von Verhaltens- und Denkmustern beitragen.
                  Ich kann mir vorstellen, dass ich die Arbeit mit und
                  Aufarbeitung von Prägungen in Zukunft bei{" "}
                  <strong>CBASP Companion</strong> noch einbauen werde.
                </p>
                <p>Vielen Dank für dein Interesse! 😊</p>
              </MoreInformationSection>
            </MoreInformationArticle>
