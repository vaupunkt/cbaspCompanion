    ...
    <>
      ...
      <KieslerkreisTextArticle>
        ...
        <KieslerkreisTextSection>
          ...
          Positionen auf dem <i>Kieslerkreis</i>. Der <i>Kieslerkreis</i> ist
          ein Kommunikationsmodell, das zwischenmenschliche Interaktionen auf
          zwei Achsen darstellt: der Achse der Kontrolle und der Achse der
          ...
          Positionen du in Zukunft gerne einnehmen möchtest, um dein Verhalten
          zu verändern und bessere Ergebnisse zu erzielen.
        </KieslerkreisTextSection>
      </KieslerkreisTextArticle>
      <KieslerkreisTextArticle>
        ...
        <KieslerkreisTextSection>
          ...
          darstellen. Kiesler nahm an, dass sich zwei Menschen immer gegenseitig
          beeinflussen, wenn sie miteinander kommunizieren. Wenn also jemand
          sehr dominant auftritt, dann wird dies in der Regel zu unterwürfigem
          Verhalten beim Gegenüber führen. Wenn jemand freundlich auftritt, wird
          er in der Regel auch eine freundliche Reaktion erhalten.
        </KieslerkreisTextSection>
        <KieslerkreisTextSection>
          ...
          Position man selbst im <i>Kieslerkreis</i> häufig einnimmt und ob man
          auf diese Weise erreichen kann, was man erreichen möchte.
        </KieslerkreisTextSection>
        <KieslerkreisTextSection>
          Insgesamt bietet der <i>Kieslerkreis</i> ein nützliches Werkzeug zur
          Analyse und Verbesserung zwischenmenschlicher Interaktionen und
          Beziehungen.
        </KieslerkreisTextSection>
      </KieslerkreisTextArticle>
    </>
